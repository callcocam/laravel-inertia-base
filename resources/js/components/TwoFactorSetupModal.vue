...
const modalConfig = computed<TwoFactorConfigContent>(() => {
    if (props.twoFactorEnabled) {
        return {
            title: t('app.settings.two_factor.modal.enabled_title'),
            description: t(
                'app.settings.two_factor.modal.enabled_description',
            ),
            buttonText: t('app.common.close'),
        };
    }

    if (showVerificationStep.value) {
        return {
            title: t('app.settings.two_factor.modal.verify_title'),
            description: t('app.settings.two_factor.modal.verify_description'),
            buttonText: t('app.common.continue'),
        };
    }

    return {
        title: t('app.settings.two_factor.modal.setup_title'),
        description: t('app.settings.two_factor.modal.setup_description'),
        buttonText: t('app.common.continue'),
    };
});
                    ...
                    <template v-else>
                        ...
                        >
                            ...
                            <span class="bg-card relative px-2 py-1">{{
                                t('app.settings.two_factor.modal.manual_entry')
                            }}</span>
                        </div>
