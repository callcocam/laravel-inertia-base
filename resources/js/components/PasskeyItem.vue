            ...
            <div class="space-y-1">
                ...
                <p class="text-muted-foreground text-sm">
                    ...
                    <template v-if="passkey.last_used_at_diff">
                        ...
                        {{
                            t('app.settings.passkeys.last_used', {
        ...
        <Dialog>
            <DialogTrigger as-child>
                ...
                >
                    ...
                    <span class="sr-only">{{
                        t('app.settings.passkeys.remove')
                    }}</span>
                </Button>
            </DialogTrigger>
            ...
            <DialogContent>
                <DialogTitle>{{
                    t('app.settings.passkeys.remove_title')
                }}</DialogTitle>
                <DialogDescription>
                    {{
                        t('app.settings.passkeys.remove_description', {
                            name: passkey.name,
                        })
                    }}
                </DialogDescription>
                <DialogFooter class="gap-2">
                    ...
                    >
                        {{
                            isDeleting
                                ? t('app.settings.passkeys.removing')
                                : t('app.settings.passkeys.remove_confirm')
                        }}
                    </Button>
                </DialogFooter>
            </DialogContent>
