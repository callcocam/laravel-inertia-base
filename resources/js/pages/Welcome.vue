...
<template>
    <Head :title="t('app.welcome.head_title')">
    ...
    >
        ...
        >
            <nav class="flex items-center justify-end gap-4">
                ...
                <template v-else>
                    ...
                    >
                        {{ t('app.welcome.log_in') }}
                    </Link>
                    <Link
                        :href="register()"
                        class="inline-block rounded-sm border border-[#19140035] px-5 py-1.5 text-sm leading-normal text-[#1b1b18] hover:border-[#1915014a] dark:border-[#3E3E3A] dark:text-[#EDEDEC] dark:hover:border-[#62605b]"
                    >
                        {{ t('app.welcome.register') }}
                    </Link>
                </template>
            </nav>
        </header>
        ...
        >
            ...
            >
                ...
                >
                    <h1 class="mb-1 font-medium">{{ t('app.welcome.get_started') }}</h1>
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                        {{ t('app.welcome.intro_line1') }} <br />{{
                            t('app.welcome.intro_line2')
                        }}
                    </p>
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        ...
                        >
                            ...
                            <span>
                                {{ t('app.welcome.read_the') }}
                                <a
                                    href="https://laravel.com/docs"
                                    target="_blank"
                                    class="ml-1 inline-flex items-center space-x-1 font-medium text-[#f53003] underline underline-offset-4 dark:text-[#FF4433]"
                                >
                                    <span>{{ t('app.welcome.documentation') }}</span>
                                    <svg
                                        width="10"
                                        height="11"
                                        viewBox="0 0 10 11"
                        ...
                        >
                            ...
                            <span>
                                {{ t('app.welcome.watch_tutorials') }}
                                <a
                                    href="https://laracasts.com"
                                    target="_blank"
                                    class="ml-1 inline-flex items-center space-x-1 font-medium text-[#f53003] underline underline-offset-4 dark:text-[#FF4433]"
                                >
                                    <span>{{ t('app.welcome.laracasts') }}</span>
                                    <svg
                                        width="10"
                                        height="11"
                                        viewBox="0 0 10 11"
